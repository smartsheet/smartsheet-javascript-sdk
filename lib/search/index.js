...
exports.create = function (options) {
   ...
   * @param {object} getOptions - Container for values passed to the get request
   * @param {string} getOptions.query - text to search for
   * @param {object} getOptions.queryParameters - Object containing queryParameters to use in the get request
