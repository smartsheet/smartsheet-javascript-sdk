  ...
  var sharesWrapper = {
    create: function(options) {
      ...
      return {
        ...
        share: shareSheet, // Alias for backward compatibility
        getShare: getSheetShares, // Alias for backward compatibility
        listShares: getSheetShares, // Alias for backward compatibility
