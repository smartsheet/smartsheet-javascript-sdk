...
import { acceptHeaders as headers } from '../utils/constants.js';
...
export function create(options) {
  ...
  var createSheet = (postOptions, callback) => requestor.post(_.extend({}, optionsToSend, postOptions), callback);
