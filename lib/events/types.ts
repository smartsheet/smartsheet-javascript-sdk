...
export type GetEventsCallback = (error: ApiError, response: GetEventsResponse, body: any) => void;

export interface EventsModule {
    getEvents: (getOptions: GetEventsOptions, callback?: GetEventsCallback) => void;
}