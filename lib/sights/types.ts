...
export type ListSights = (options: ListSightsOptions, callback: RequestCallback<ListSightsResponse>) => Promise<ListSightsResponse>;
export type DeleteSight = (options: DeleteSightOptions, callback: RequestCallback<DeleteSightResponse>) => Promise<DeleteSightResponse>;
export type UpdateSight = (options: UpdateSightOptions, callback: RequestCallback<UpdateSightResponse>) => Promise<UpdateSightResponse>;
export type CopySight = (options: CopySightOptions, callback: RequestCallback<CopySightResponse>) => Promise<CopySightResponse>;
export type MoveSight = (options: MoveSightOptions, callback: RequestCallback<MoveSightResponse>) => Promise<MoveSightResponse>;
export type GetSightPublishStatus = (options: GetSightPublishStatusOptions, callback: RequestCallback<SightPublishStatus>) => Promise<SightPublishStatus>;
export type SetSightPublishStatus = (options: SetSightPublishStatusOptions, callback: RequestCallback<SetSightPublishStatusResponse>) => Promise<SetSightPublishStatusResponse>;
