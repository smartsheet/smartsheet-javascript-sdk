  ...
  var sharesWrapper = {
    create: function(options) {
      ...
      return {
        ...
        getShare: getWorkspaceShares, // Alias for backward compatibility
        share: shareWorkspace, // Alias for backward compatibility
        listShares: getWorkspaceShares, // Alias for backward compatibility
