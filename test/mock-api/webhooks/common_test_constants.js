...
const TEST_SHEET_WEBHOOK_REQUEST_BODY = {
...
const TEST_PLAN_WEBHOOK_REQUEST_BODY = {
  name: TEST_WEBHOOK_NAME,
  callbackUrl: TEST_CALLBACK_URL,
...
const TEST_UPDATE_WEBHOOK_REQUEST_BODY_MINIMAL = {
  enabled: true
};

const TEST_UPDATE_SHEET_WEBHOOK_REQUEST_BODY = {
  name: TEST_WEBHOOK_NAME,
  enabled: true
};

const TEST_UPDATE_PLAN_WEBHOOK_REQUEST_BODY = {
  name: TEST_WEBHOOK_NAME,
  enabled: true,
  customHeaders: TEST_CUSTOM_HEADERS
};
