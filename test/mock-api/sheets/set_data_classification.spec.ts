...
describe('Sheets - setDataClassification endpoint tests', () => {
    ...
    it('setDataClassification generated url is correct', async () => {
        ...
        await client.sheets.setDataClassification(options);
    ...
    it('setDataClassification error 400 response', async () => {
        const requestId = crypto.randomUUID();
        const options = {
            sheetId: TEST_SHEET_ID,
            body: testBody,
