    ...
    var testGroups = [
        ...
        },
        {
            ...
            methods: [
                ...
                { name: 'deleteUserFromPlan', stub: 'delete', options: { userId: 123, planId: 456 }, expectedRequest: { url: "users/123/plans/456" }},
                { name: 'getUserPlans', stub: 'get', options: { userId: 123 }, expectedRequest: { url: "users/123/plans" }},
                { name: 'listUsers', stub: 'get', options: { planId: 123, seatType: 'VIEWER', emails: ['a@b.com'], pageSize: 10, page: 1, numericDates: false }, expectedRequest: { url: "users/", queryParameters: { planId: 123, seatType: 'VIEWER', emails: ['a@b.com'], pageSize: 10, page: 1, numericDates: false }}},
