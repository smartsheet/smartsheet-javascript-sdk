    ...
    const testGroups = [
        ...
        },
        {
            ...
            methods: [
                ...
                { name: 'removeTemplateFromFavorites', stub: 'delete', options: { favoriteId: 123 }, expectedRequest: {url: "favorites/template/123" }},
                { name: 'removeSightFromFavorites', stub: 'delete', options: { favoriteId: 123 }, expectedRequest: {url: "favorites/sight/123" }},
                { name: 'removeWorkspaceFromFavorites', stub: 'delete', options: { favoriteId: 123 }, expectedRequest: {url: "favorites/workspace/123" }},
        ...
        },
        {
            name: 'users',
            methods: [
                { name: 'getUser', stub: 'get', options: {userId: 123}, expectedRequest: {url: "users/123"}},
                ...
                { name: 'addUserAndSendEmail', stub: 'post', options: {}, expectedRequest: {url: "users"}},
                { name: 'updateUser', stub: 'put', options: {userId: 123}, expectedRequest: {url: "users/123"}},
                { name: 'removeUser', stub: 'delete', options: {userId: 123}, expectedRequest: {url: "users/123"}},
