...
describe('Utils Unit Tests', function() {
  ...
  describe('#POST', function() {
    ...
    describe('#Arguments', function() {
      ...
      it('headers sent as part of request should match given', () => {
        ...
        spyPost.args[0][1].headers.Authorization.should.equal(sampleHeaders.Authorization);
        spyPost.args[0][1].headers.Accept.should.equal(sampleHeaders.Accept);
        spyPost.args[0][1].headers['Content-Type'].should.equal(sampleHeaders['Content-Type']);
        spyPost.args[0][1].headers['User-Agent'].should.equal(sampleHeaders['User-Agent']);
      });
      ...
      it('queryString sent to request should match given', () => {
        ...
        spyPost.args[0][1].params.should.equal(sampleRequestWithQueryParameters.queryParameters);
      });

      it('body sent to request should match given', () => {
        requestor.post(sampleRequestWithQueryParameters);
        spyPost.args[0][1].body.should.equal(JSON.stringify(sampleRequestWithQueryParameters.body));
      });
    });
  ...
  describe('#PUT', function() {
    ...
    describe('#Arguments', function() {
      ...
      it('body sent to request should match given', () => {
        requestor.put(sampleRequestWithQueryParameters);
        spyPut.args[0][1].body.should.equal(JSON.stringify(sampleRequestWithQueryParameters.body));
      });
    });
